...
export default async function TermsPageIos() {
...
async function getTerms() {
    ...
    return result.items.find(item => item.fields.title.toLowerCase().includes('terms/ios'))!.fields
}
...
export async function generateMetadata(_: any, parent: ResolvingMetadata): Promise<Metadata> {
    ...
    const fields = result.items.find(item => item.fields.title.toLowerCase().includes('terms/ios'))!.fields.seo?.fields;
